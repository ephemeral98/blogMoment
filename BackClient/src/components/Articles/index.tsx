      ...
      >
        ...
        <div className={css.main}>
          ...
          <div className={css.article_content}>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti, architecto ab
            pariatur nulla necessitatibus animi soluta natus nisi ratione temporibus?
          </div>
